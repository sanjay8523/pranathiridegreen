...
// External Pages (Ensure these exist in your /pages folder)
...
const SearchRides = () => {
  ...
  useEffect(() => {
    ...
    const filtered = rides.filter((ride) => {
      const matchOrigin =
        !searchOrigin ||
        normalizeText(ride.origin) === normalizeText(searchOrigin);
      const matchDestination =
        !searchDestination ||
        normalizeText(ride.destination) === normalizeText(searchDestination);
            ...
            {filteredRides.length === 0 ? (
              ...
              filteredRides.map((ride) => {
                ...
                return (
                  <div
                    key={ride._id}
                    className="bg-white p-6 rounded-2xl hover:shadow-2xl transition-all cursor-pointer border-2 border-transparent hover:border-emerald-500"
                    onClick={() =>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-white p-8 rounded-3xl shadow-xl">
              ...
              <div className="bg-emerald-50 p-5 rounded-xl border border-emerald-200">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <input
                    ...
                    disabled={isOwnRide}
                    className="w-20 bg-white border-2 border-emerald-300 rounded-lg p-2 text-center"
                  />
                </div>
                <div className="flex justify-between text-2xl font-black text-emerald-600 mt-4">
            ...
            <button
              ...
              disabled={loading || isOwnRide || !razorpayLoaded}
